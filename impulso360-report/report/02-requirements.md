...
| **ESTRATEGIAS DE MARKETING** | - Educación sobre la digitalización<br>- Participación en eventos de emprendedores<br>- Publicidad digital dentro de la plataforma<br>- Captación directa (redes sociales) | - Su estrategia es mediante su modelo freemium, lo que facilita la entrada de nuevos negocios.                | - Se enfoca en su marketplace, además de que se enfoca en atraer clientes hacia los negocios dentro de la plataforma. | - Su marketing resalta la gestión completa del negocio mediante la integración de servicio, enfocado en negocios ya establecidos. |
| **PERFIL DE PRODUCTO**       |                                                                                                                                                                            |                                                                                                               |                                                                                                                       |                                                                                                                                   |
| **PRODUCTOS & SERVICIOS**    | - Agenda digital<br>- Recordatorios<br>- Perfil digital del negocio<br>- Perfil                                                                                            | - Reservas<br>- Gestión de clientes<br>- Recordatorios                                                        | - Agenda<br>- Marketplace<br>- Descubrimiento de servicios<br>- Promoción dentro de la app                            | - Agenda<br>- Gestión de clientes<br>- Pagos integrados                                                                           |
| **PRECIOS & COSTOS**         | - Suscripción mensual accesible<br>- Modelo simple (sin costos ocultos)                                                                                                    | - Comisiones<br>- Marketing pagado                                                                            | - Suscripción<br>- Visibilidad premium                                                                                | - Suscripción escalable                                                                                                           |
...
| **OPORTUNIDADES**            | - Baja digitalización en Perú.<br>- Crecimiento del mercado de microempresas<br>- Expansión a múltiples sectores                                                           | - Expansión a mercados emergentes.<br>- Diversificación de servicios                                          | - Crecimiento del mercado local<br>- Integración con más sectores                                                     | - Mayor digitalización del sector formal<br>- Integración con otros sistemas de pago                                              |
| **AMENAZAS**                 | - Entrada de competidores internacionales<br>- Cambios en normativas de datos                                                                                              | - Saturación del mercado<br>- Competidores locales más económicos                                             | - Nuevas plataformas con mejores comisiones<br>- Cambios en hábitos de consumo                                        | - Plataformas de nicho más especializadas<br>- Costos de mantener infraestructura                                                 |
...
| ----------------------- | --------------------------------- | ----------------------------------------------------------------------------------------------- |
| **Precio**              | $20-100/mes transparente          | Fresha: comisiones variables<br>Booksy: suscripción + visibilidad<br>Square: escalable complejo |
...
| **Edad**       | 45                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| **Distrito**   | San Borja                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| **Screenshot** | ![Entrevistado1](../assets/imagenes/Interviews/Interviewer-1.png)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
- **Entrevistado:** Manuel (Representante de Vitalite)
- **Formación:** [No mencionado en entrevista]
- **Personalidad:** Analítica, pragmática y calmada
- **Marcas e influencias: Meta(WhatsApp), Google (Calendar y Gmail) y Microsoft (Excel).
- **Tecnología:*so de tecnología básicas y gratuita para la geión del negocio.
- **Dispositivos:** [No mencionado en la entrevista]
- **Browser:** Cualquier navegador web
- **Canales de interacción:** WhatsApunicación directa y redes sociales para expansión de alcance 
- **Características objetivas:** Doirige microempresa médica que atiende entre 150 y 200 pacientes mensuales. Gestiona el negocio manualmente mediante ingreso de datos en Excel y Calendar. Ha impledo estrategias de doble verificación y cacitación ante la pérdida de citas por errores de agenda.
- **Características subjetivas:** Enfocado en la rentabilidad y la eficiencia operativa. Considera que la automatización de sus sistemas actuales le permitiría ahorrar cinco horas semanales para reinvertis en promoción, pagos e inventario. Confía en el "boca a boca" como método de crecimiento.
...
| **Edad**       | 60                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| **Distrito**   | Lima                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| **Screenshot** | ![Entrevistado2](../assets/imagenes/Interviews/interviewer-2.png)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
- **Entrevistado:** Isabel Carrera (Estudio Jurídico).
- **Formación:** Se infiere perfil legal.
- **Personalidad:** Resiliente, organizada y con sentido de responsabilidad social.
- **Marcas e influencias:** Utiliza servicios de correo electronico.
- **Tecnología:** Uso de herramientas digitales básicas y métodos tradicionales para la gestión de servicios de consulta legal.
- **Dispositivos:** Teléfono (para llamadas) y computadora/laptop (para correos).
- **Browser:** Cualquier navegador web
- **Canales de interacción:** Vía telefónica, física y correo electrónico. El crecimiento de su cartera se basa principalmente en la recomendación (boca a boca). 
- **Características objetivas:** Gestiona un estudio jurídico con un flujo de aproximadamente 20 clientes mensuales. Ha experimentado pérdida de citas debido a su sistema de agenda actual, lo que la llevó a implementar una estrategia de confirmaciones constantes. Reporta una curva de aprendizaje corta para el uso de sus herramientas actuales.
- **Características subjetivas:** Valora la fiabilidad por encima de la complejidad, destacando los recordatorios como la funcionalidad crítica para cualquier sistema de agenda. Posee un fuerte enfoque altruista: proyecta utilizar el tiempo ahorrado en brindar asesoría legal gratuita a comunidades vulnerables que no pueden costear sus servicios.
...
| **Edad**       | 23                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| **Distrito**   | San Isidro                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| **Screenshot** | ![Entrevistado3](../assets/imagenes/Interviews/Interviewer-3.png)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
- **Entrevistado:**  Angel Barrera (Gestión de Viviendas de Alquiler).
- **Formación:** Se infiere a asesor en ventas.
- **Personalidad:** Ambicioso, consciente del mercado y con mentalidad de crecimiento.
- **Marcas e influencias:** Meta (Instagram y WhatsApp), Inteligencia artificial (identificado como competencia indirecta)
- **Tecnología:** Uso de redes sociales para publicidad, pero con una infraestructura interna limitada o nula para la gestión de datos.
- **Dispositivos:** Uso intensivo de Smartphone.
- **Browser:** Cualquier navegador web.
- **Canales de interacción:**  Instagram para captación de clientes y WhatsApp para atención directa.
- **Características objetivas:** Dirige un servicio de organización para propietarios de viviendas alquiladas. Cuenta con un flujo de 20 clientes nuevos recurrentes cada mes. Sufre una pérdida crítica de clientes debido a la saturación de mensajes en WhatsApp y la falta de un sistema de respuesta organizado. Carece de una estructura para brindar información estandarizada a los interesados.
- **Características subjetivas:** Identifica a la IA e Internet como amenazas para su posicionamiento, ya que los usuarios buscan soluciones por cuenta propia. Ve la digitalización no solo como una herramienta, sino como el "siguiente gran paso" para escalar su negocio. Valora la organización como la clave para no perder oportunidades de venta ante el crecimiento acelerado de su emprendimiento.
...
| **Edad**       | 24                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| **Distrito**   | Piura                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| **Screenshot** | ![Entrevistado4](../assets/imagenes/Interviews/interviewer-4.png)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
- **Entrevistado:** Jorge David Centenas (Incubic)
- **Formación:** No mencionado en entrevista, pero maneja software especializado de impresión 3D
- **Personalidad:** Emprendedora, proactiva y orientada a la profesionalización.
- **Marcas e influencias:** Microsoft (Excel), Trello, Google Ads, Redes Sociales (Instagram/Facebook) y software de modelado/impresión 3D.
- **Tecnología:** Uso de herramientas de gestión de proyectos y publicidad pagada; cuenta con tecnología de impresión 3D como núcleo del negocio.
- **Dispositivos:** Laptop/PC para software 3D y Smartphone para atención
- **Browser:** Cualquier navegador web.
- **Canales de interacción:**  Redes sociales para prospectos (40 mensuales), ferias presenciales (canal de mayor acogida) y Google Ads.
- **Características objetivas:** Lidera un equipo de 4 asesores en un negocio de figuras artesanales 3D en el norte del Perú. Maneja un ticket promedio de entre S/.5 y S/.150. Presenta fallas operativas como cruces de inventario y olvido de pedidos debido al uso de herramientas manuales (Excel). Tiene una tasa de conversión del 33% y pierde entre el 10-15% de ventas por falta de tiempo o respuesta inmediata.
- **Características subjetivas:** Considera la digitalización como la ruta para evitar "perder clientes en caliente". Muestra una alta disposición al pago (hasta $20 mensuales) si la herramienta garantiza atención 24/7 y analítica de datos. Valora la ventaja competitiva de ser pionero tecnológico en su región, pero reconoce la dificultad de comunicar su propuesta de valor.
</div>
 |
...
| **Edad**       | 28                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| **Distrito**   | San Borja                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| **Screenshot** | ![Entrevistado5](../assets/imagenes/Interviews/Interviewer-5.png)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
- **Entrevistado:** Rut Camacho (Glow Studio)
- **Formación:** Se infiere perfil en cosmetología/estética
- **Personalidad:** Colaborativa (trabaja con socia), abierta a la inversión tecnológica y enfocada en la experiencia del cliente.
- **Marcas e influencias:** Meta (WhatsApp e Instagram para gestión y captación).
- **Tecnología:** Manejo de procesos de forma predominantemente manual; dependencia de redes sociales para la coordinación básica de servicios.
- **Dispositivos:** Se infiere uso de Smartphone para redes sociales
- **Browser:** Cualquier navegador web.
- **Canales de interacción:** WhatsApp e Instagram como canales principales de reserva y atención.
- **Características objetivas:** Lidera un estudio de belleza y peluquería especializado en mujeres con un flujo de 80 a 120 clientas mensuales. Ofrece una gama variada de servicios (peinados, cortes, tratamientos y maquillaje). Presenta ineficiencias operativas como cruces de horarios y pérdida de citas por falta de confirmación. Reporta incidentes financieros donde clientas realizan adelantos de pago pero no asisten a la cita.
- **Características subjetivas:** Muestra una disposición positiva hacia el pago por una plataforma de organización. Valora la formalización del sistema de citas para evitar el ausentismo y mejorar la puntualidad. Considera que la transición de lo manual a lo digital es una necesidad actual para la estabilidad de su negocio junto a su socia.
</div> |
...
| **Edad**       | 32                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| **Distrito**   | Tarapoto                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| **Screenshot** | ![Entrevistado6](../assets/imagenes/Interviews/Interviewer-unknow.png)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
- **Entrevistado: Arturo Ruiz (Representante de Global Salva, E-commerce de productos en tendencia)
- **Formación:** Marketing Digital en la UPC y cursos independientes
- **Personalidad:** Estratégica, orientada a la escala y con enfoque en la automatización de procesos.
- **Marcas e influencias:** Meta (WhatsApp API, Meta Ads), TikTok Ads, Lucid Bot.
- **Tecnología:** Uso de herramientas de automatización de alto nivel (Bots) e integración de APIs para la gestión masiva de leads.
- **Dispositivos:** MacBook Air para gestión laboral, uso de Lucid Bot o usar google sheets.
- **Browser:** Cualquier navegador web.
- **Canales de interacción:** WhatsApp API como eje central de cierre; Meta Ads y TikTok Ads como canales principales de captación de prospectos.
- **Características objetivas:** Opera un e-commerce con un flujo de 2,000 a 3,000 prospectos mensuales y una tasa de conversión del 33% al 50%. Invierte mensualmente entre $80 y $100 en infraestructura de atención automatizada. Ha logrado reducir el "pain point" de la demora en respuesta mediante la migración tecnológica. Mantiene márgenes de ganancia de entre el 20% y 30%.
- **Características subjetivas:** Reconoce que el aprendizaje digital es un proceso continuo. A diferencia de otros emprendedores, su foco ya no es la atención al cliente (la cual ya resolvió), sino la coordinación operativa interna. Valora el tiempo ahorrado como un recurso para mejorar la gestión del equipo humano detrás de la operación.
</div>  |
...
![UserPersonaS1](../assets/imagenes/needfinding/user-persona-1.png)

![UserPersonaS2](../assets/imagenes/needfinding/user-persona-2.png)
...
![JourneyMapping1](../assets/imagenes/needfinding/journey-mapping-1.png)

![JourneyMapping2](../assets/imagenes/needfinding/journey-mapping-2.png)

---

### 2.3.4. Empathy Mapping

![EmpathyMapping1](../assets/imagenes/needfinding/empathy-mapping-1.png)

## ![EmpathyMapping2](../assets/imagenes/needfinding/empathy-mapping-2.png)
...
![Unordered-events](../assets/imagenes/needfinding/unordered-events.png)
